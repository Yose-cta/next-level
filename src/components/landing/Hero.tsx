    ...
    <section className="sec-dark relative min-h-[calc(100vh-3.5rem)] flex items-center pt-12 pb-20 sm:pt-16 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 order-2 lg:order-1 reveal relative z-10">
            ...
            >
              Si <span className="text-white">recién empiezas</span>, sales con bases más claras.
              Si ya <span className="text-white">vendes</span>, sales sabiendo qué ajustar y qué
              soltar para crecer mejor.
            </p>
          ...
          <div className="lg:col-span-5 order-1 lg:order-2 reveal reveal-delayed">
